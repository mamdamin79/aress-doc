const colors = {
  ...
  text: {
    ...
    onmessage: {
      neutral: {
        ...
        secondary: {
          on100_50: 'var(--color-text-onmessage-neutral-secondary-on100_50)',
        },
      },
      colored: {
        oninfo: {
          on200_100: 'var(--color-text-onmessage-colored-oninfo-on200_100)',
        },
        onerror: {
          on200_100: 'var(--color-text-onmessage-colored-onerror-on200_100)',
        },
        onsuccess: {
          on200_100: 'var(--color-text-onmessage-colored-onsuccess-on200_100)',
        },
        onwarning: {
          on200_100: 'var(--color-text-onmessage-colored-onwarning-on200_100)',
        },
      },
    },
    onaccent: {
  ...
  icon: {
    ...
    onmessage: {
      ...
      colored: {
        oninfo: {
          on200_100: 'var(--color-icon-onmessage-colored-oninfo-on200_100)',
        },
        onerror: {
          on200_100: 'var(--color-icon-onmessage-colored-onerror-on200_100)',
        },
        onsuccess: {
          on200_100: 'var(--color-icon-onmessage-colored-onsuccess-on200_100)',
        },
        onwarning: {
          on200_100: 'var(--color-icon-onmessage-colored-onwarning-on200_100)',
        },
      },
    },
    onaccent: {
