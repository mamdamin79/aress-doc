...
export const NewBadge = () => {
  return (
    <div className="flex h-[22px] w-[37px] items-center justify-center rounded-[100px] bg-gradient-to-b from-red-600 to-red-700 p-2 text-xs font-medium text-white">
      جدید
    </div>
  );
};
