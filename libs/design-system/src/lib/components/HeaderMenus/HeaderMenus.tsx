    ...
    <div className="flex items-center gap-6 text-nowrap">
      {menuItems.map((item, index) => (
        <Popover key={index} className="group relative h-[40px]">
          ...
          {/* Dropdown panel */}
          {item.subMenu && (
            <div className="bg-baseBackground shadow-offset-y-10 absolute z-10 mt-2 flex hidden h-fit w-fit max-w-[272px] flex-col gap-2 rounded-xl border-2 border-gray-300 py-4 text-right shadow-md group-hover:block">
