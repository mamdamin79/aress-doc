// Importing various icons from the public directory
...
// Importing types for FooterSection and Icon component
import { FooterSection } from './Footer.types';
import { Icon } from '../IconComponent';

// Defining the footer links structure
...
// Exporting imported icons for use in other components
export {
  logo,
  enamad,
  electronik,
