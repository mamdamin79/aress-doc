  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 justify-center items-center transition-all">
        <div className="w-[72px] h-[72px] rounded-full border-2 border-dashed border-gray-500 group-hover/reportBtn:border-brand-700 flex justify-center items-center">
