...
export const AddReportButton: React.FC<AddReportButtonProps> = ({
  ...
  return (
    <div className="shadow-6xl flex h-[336px] max-w-[616px] items-center justify-center rounded-2xl border-2 border-gray-200 bg-white text-lg font-medium text-gray-600">
      <button
        onClick={onClick}
