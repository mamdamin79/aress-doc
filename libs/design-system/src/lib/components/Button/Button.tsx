    ...
    <button
      ...
      className={cn(
        ...
        mode === 'secondary' &&
          ...
          !disabled &&
          (theme === 'brand'
            ? 'border-brand-600 text-brand-600 hover:bg-brand-700 active:bg-brand-800 border bg-white hover:text-white'
            : theme === 'error'
          ...
          (theme === 'brand'
            ...
            : theme === 'error'
              ...
              : theme === 'success'
                ...
                : 'text-gray-600 active:border-gray-800 active:text-gray-800'),
        className,
      )}
    >
      {isLoading ? (
