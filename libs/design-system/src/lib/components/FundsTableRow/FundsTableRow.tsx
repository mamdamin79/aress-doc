...
export function FundsTableRow({
  ...
  return (
    <div
      className={cn(
        'group flex w-full h-[64px] cursor-pointer items-center justify-between',
        {
          'bg-blue-50 hover:bg-blue-100': pined,
          'bg-blue-200': selected,
          'shadow-lg': shadow,
          'hover:bg-blue-50': !selected && !pined,
        },
      )}
    >
      <div
        className={cn(
          'sticky right-0 flex w-[400px] items-center justify-between bg-white',
          {
