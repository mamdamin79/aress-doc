  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        walletMovablePart3: 'walletMovablePart3 1s ease-in-out forwards',
        walletMovablePart1: 'walletMovablePart1 1s ease-in-out forwards',
        walletMovablePart2: 'walletMovablePart2 1s ease-in-out forwards',
      },
      fontFamily: {
        vazirmatn: 'vazirmatn',
      },
