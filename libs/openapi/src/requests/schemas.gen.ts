...
export const $FundReturnAnalysisRiskReturnAnalysisChartItemApiModel = {
    ...
    type: 'object',
    required: ['fundId', 'abbreviatedName', 'risk', 'returnPercent', 'netAssetsRials', 'colorHex'],
...
export const $FundSummaryBaseInfoApiModel = {
    ...
    type: 'object',
    required: ['manager', 'investmentStrategy', 'assetUnderManagementRials', 'alphaSinceInitiationPercent', 'betaSinceInitiationPercent', 'leverageSinceInitiationPercent', 'investedUnits', 'initiationDate', 'initiationJdate', 'lastUpdateDate', 'lastUpdateJdate', 'timeSinceInitiation'],
...
export const $FundTableItemInfoApiModel = {
    ...
    type: 'object',
    required: ['identifier', 'registrationNumber', 'name', 'abbreviatedName', 'investmentStrategy', 'fundType', 'logoMedium', 'logoThumbnail', 'website', 'statuteUrl', 'prospectusUrl', 'isEtf', 'isCharity', 'hasVideo', 'manager', 'custodian', 'auditor', 'liquidityGuarantor', 'marketMaker', 'initiationDate', 'initiationJdate', 'issueNavRials', 'redeemNavRials', 'statisticalNavRials', 'assetUnderManagementRials', 'numberOfUnits', 'returnLastDayPercent', 'returnLastWeekPercent', 'returnLastMonthPercent', 'returnLast3MonthsPercent', 'returnLast6MonthsPercent', 'returnLastYearPercent', 'returnCustomPeriodPercent', 'returnVsTedpixLastDayPercent', 'returnVsTedpixLastWeekPercent', 'returnVsTedpixLastMonthPercent', 'returnVsTedpixLast3MonthsPercent', 'returnVsTedpixLast6MonthsPercent', 'returnVsTedpixLastYearPercent', 'returnVsTedpixCustomPeriodPercent', 'assetAllocationBondPercent', 'assetAllocationBankDepositPercent', 'assetAllocationCommodityDepositCertificatePercent', 'assetAllocationCashPercent', 'assetAllocationStocksIncludingTop5Percent', 'assetAllocationFundUnitsPercent', 'assetAllocationOtherPercent', 'assetAllocationTop5StocksPercent', 'averageLeverageLastWeek', 'averageLeverageLastMonth', 'averageLeverageLast3Months', 'averageLeverageLast6Months', 'averageLeverageLastYear', 'averageLeverageCustomPeriod', 'standardDeviationLastWeek', 'standardDeviationLastMonth', 'standardDeviationLast3Months', 'standardDeviationLast6Months', 'standardDeviationLastYear', 'standardDeviationCustomPeriod', 'sharpeRatioLastWeek', 'sharpeRatioLastMonth', 'sharpeRatioLast3Months', 'sharpeRatioLast6Months', 'sharpeRatioLastYear', 'sharpeRatioCustomPeriod', 'informationRatioLastWeek', 'informationRatioLastMonth', 'informationRatioLast3Months', 'informationRatioLast6Months', 'informationRatioLastYear', 'informationRatioCustomPeriod', 'alphaLastDay', 'alphaLastWeek', 'alphaLastMonth', 'alphaLast3Months', 'alphaLast6Months', 'alphaLastYear', 'alphaCustomPeriod', 'betaLastDay', 'betaLastWeek', 'betaLastMonth', 'betaLast3Months', 'betaLast6Months', 'betaLastYear', 'betaCustomPeriod', 'maxDrawdownWeek', 'maxDrawdownMonth', 'maxDrawdown3Months', 'maxDrawdown6Months', 'maxDrawdownYear', 'maxDrawdownCustomPeriod'],
...
export const $FundTableResponseApiModel = {
    ...
    type: 'object',
    required: ['tabs', 'selectedTabIdentifier', 'selectedTabFunds', 'columns', 'columnGroups', 'defaultColumns'],
...
export const $FundTableTabColumnDto = {
    ...
    type: 'object',
    required: ['label', 'upperTitle', 'lowerTitle', 'key', 'visible', 'sort', 'colorFormat', 'columnGroupId', 'nameInGroup', 'customPeriodStartJdate', 'customPeriodEndJdate'],
...
export const $VideoThumbnailApiModel = {
    ...
    type: 'object',
    required: ['startTimeSeconds', 'durationSeconds', 'image', 'intervalSeconds', 'widthPixels', 'heightPixels', 'columns', 'totalFrames'],
