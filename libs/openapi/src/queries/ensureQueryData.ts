...
export const ensureUseFundsServiceGetFundsTypeByFundTypeData = (queryClient: QueryClient, { fundType }: {
  fundType: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseFundsServiceGetFundsTypeByFundTypeKeyFn({ fundType }), queryFn: () => FundsService.getFundsTypeByFundType({ fundType }) });
export const ensureUseFundsServiceGetFundsTableData = (queryClient: QueryClient, { tab }: {
  tab?: number;
} = {}) => queryClient.ensureQueryData({ queryKey: Common.UseFundsServiceGetFundsTableKeyFn({ tab }), queryFn: () => FundsService.getFundsTable({ tab }) });
export const ensureUseFundsServiceGetFundsTableTabByTabCsvData = (queryClient: QueryClient, { tab }: {
  tab: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseFundsServiceGetFundsTableTabByTabCsvKeyFn({ tab }), queryFn: () => FundsService.getFundsTableTabByTabCsv({ tab }) });
export const ensureUseFundsServiceGetFundsStockByFundIdSummaryData = (queryClient: QueryClient, { fundId }: {
  fundId: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseFundsServiceGetFundsStockByFundIdSummaryKeyFn({ fundId }), queryFn: () => FundsService.getFundsStockByFundIdSummary({ fundId }) });
export const ensureUseFundsServiceGetFundsStockByFundIdReturnAnalysisData = (queryClient: QueryClient, { fundId }: {
  fundId: number;
}) => queryClient.ensureQueryData({ queryKey: Common.UseFundsServiceGetFundsStockByFundIdReturnAnalysisKeyFn({ fundId }), queryFn: () => FundsService.getFundsStockByFundIdReturnAnalysis({ fundId }) });
