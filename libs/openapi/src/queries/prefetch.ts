...
export const prefetchUseFundsServiceGetFundsTypeByFundType = (queryClient: QueryClient, { fundType }: {
  fundType: number;
}) => queryClient.prefetchQuery({ queryKey: Common.UseFundsServiceGetFundsTypeByFundTypeKeyFn({ fundType }), queryFn: () => FundsService.getFundsTypeByFundType({ fundType }) });
export const prefetchUseFundsServiceGetFundsTable = (queryClient: QueryClient, { tab }: {
  tab?: number;
} = {}) => queryClient.prefetchQuery({ queryKey: Common.UseFundsServiceGetFundsTableKeyFn({ tab }), queryFn: () => FundsService.getFundsTable({ tab }) });
export const prefetchUseFundsServiceGetFundsTableTabByTabCsv = (queryClient: QueryClient, { tab }: {
  tab: number;
}) => queryClient.prefetchQuery({ queryKey: Common.UseFundsServiceGetFundsTableTabByTabCsvKeyFn({ tab }), queryFn: () => FundsService.getFundsTableTabByTabCsv({ tab }) });
export const prefetchUseFundsServiceGetFundsStockByFundIdSummary = (queryClient: QueryClient, { fundId }: {
  fundId: number;
}) => queryClient.prefetchQuery({ queryKey: Common.UseFundsServiceGetFundsStockByFundIdSummaryKeyFn({ fundId }), queryFn: () => FundsService.getFundsStockByFundIdSummary({ fundId }) });
export const prefetchUseFundsServiceGetFundsStockByFundIdReturnAnalysis = (queryClient: QueryClient, { fundId }: {
  fundId: number;
}) => queryClient.prefetchQuery({ queryKey: Common.UseFundsServiceGetFundsStockByFundIdReturnAnalysisKeyFn({ fundId }), queryFn: () => FundsService.getFundsStockByFundIdReturnAnalysis({ fundId }) });
