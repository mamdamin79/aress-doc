...
export type UsersServiceGetUsersPasswordForgotCaptchaDefaultResponse = Awaited<ReturnType<typeof UsersService.getUsersPasswordForgotCaptcha>>;
export type UsersServiceGetUsersPasswordForgotCaptchaQueryResult<TData = UsersServiceGetUsersPasswordForgotCaptchaDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useUsersServiceGetUsersPasswordForgotCaptchaKey = "UsersServiceGetUsersPasswordForgotCaptcha";
export const UseUsersServiceGetUsersPasswordForgotCaptchaKeyFn = ({ captchaHeight, captchaType, captchaWidth }: {
  captchaHeight?: number;
  captchaType?: CaptchaType;
  captchaWidth?: number;
} = {}, queryKey?: Array<unknown>) => [useUsersServiceGetUsersPasswordForgotCaptchaKey, ...(queryKey ?? [{ captchaHeight, captchaType, captchaWidth }])];
...
export const UseReportsServiceGetReportsByReportIdKeyFn = ({ reportId, screenshotQueryId }: {
  reportId: string;
  screenshotQueryId?: string;
}, queryKey?: Array<unknown>) => [useReportsServiceGetReportsByReportIdKey, ...(queryKey ?? [{ reportId, screenshotQueryId }])];
...
export type FundsServiceGetFundsTableTabByTabCsvDefaultResponse = Awaited<ReturnType<typeof FundsService.getFundsTableTabByTabCsv>>;
export type FundsServiceGetFundsTableTabByTabCsvQueryResult<TData = FundsServiceGetFundsTableTabByTabCsvDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useFundsServiceGetFundsTableTabByTabCsvKey = "FundsServiceGetFundsTableTabByTabCsv";
export const UseFundsServiceGetFundsTableTabByTabCsvKeyFn = ({ tab }: {
  tab: number;
}, queryKey?: Array<unknown>) => [useFundsServiceGetFundsTableTabByTabCsvKey, ...(queryKey ?? [{ tab }])];
export type FundsServiceGetFundsStockByFundIdSummaryDefaultResponse = Awaited<ReturnType<typeof FundsService.getFundsStockByFundIdSummary>>;
export type FundsServiceGetFundsStockByFundIdSummaryQueryResult<TData = FundsServiceGetFundsStockByFundIdSummaryDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useFundsServiceGetFundsStockByFundIdSummaryKey = "FundsServiceGetFundsStockByFundIdSummary";
export const UseFundsServiceGetFundsStockByFundIdSummaryKeyFn = ({ fundId }: {
  fundId: number;
}, queryKey?: Array<unknown>) => [useFundsServiceGetFundsStockByFundIdSummaryKey, ...(queryKey ?? [{ fundId }])];
export type FundsServiceGetFundsStockByFundIdReturnAnalysisDefaultResponse = Awaited<ReturnType<typeof FundsService.getFundsStockByFundIdReturnAnalysis>>;
export type FundsServiceGetFundsStockByFundIdReturnAnalysisQueryResult<TData = FundsServiceGetFundsStockByFundIdReturnAnalysisDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useFundsServiceGetFundsStockByFundIdReturnAnalysisKey = "FundsServiceGetFundsStockByFundIdReturnAnalysis";
export const UseFundsServiceGetFundsStockByFundIdReturnAnalysisKeyFn = ({ fundId }: {
  fundId: number;
}, queryKey?: Array<unknown>) => [useFundsServiceGetFundsStockByFundIdReturnAnalysisKey, ...(queryKey ?? [{ fundId }])];
...
export type UsersServicePostUsersProfileEmailChangeOtpMutationResult = Awaited<ReturnType<typeof UsersService.postUsersProfileEmailChangeOtp>>;
export type UsersServicePostUsersProfileEmailChangeMutationResult = Awaited<ReturnType<typeof UsersService.postUsersProfileEmailChange>>;
...
export type UsersServicePostUsersLogoutMutationResult = Awaited<ReturnType<typeof UsersService.postUsersLogout>>;
export type ReportsServicePostReportsRequestMutationResult = Awaited<ReturnType<typeof ReportsService.postReportsRequest>>;
...
export type ReportsServicePostReportsByReportIdScreenshotMutationResult = Awaited<ReturnType<typeof ReportsService.postReportsByReportIdScreenshot>>;
...
export type DashboardsServicePostDashboardsByDashboardIdFundsMutationResult = Awaited<ReturnType<typeof DashboardsService.postDashboardsByDashboardIdFunds>>;
...
export type DashboardsServicePostDashboardsByDashboardIdItemsByDashboardItemIdReplaceMutationResult = Awaited<ReturnType<typeof DashboardsService.postDashboardsByDashboardIdItemsByDashboardItemIdReplace>>;
export type DashboardsServicePostDashboardsByDashboardIdItemsByDashboardItemIdScreenshotMutationResult = Awaited<ReturnType<typeof DashboardsService.postDashboardsByDashboardIdItemsByDashboardItemIdScreenshot>>;
export type DashboardsServicePostDashboardsByDashboardIdItemsByDashboardItemIdCalculationsMutationResult = Awaited<ReturnType<typeof DashboardsService.postDashboardsByDashboardIdItemsByDashboardItemIdCalculations>>;
...
export type FundsServicePostFundsTableTabByTabPinMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabPin>>;
export type FundsServicePostFundsTableTabByTabUnpinMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabUnpin>>;
export type FundsServicePostFundsByFundIdMarkMutationResult = Awaited<ReturnType<typeof FundsService.postFundsByFundIdMark>>;
export type FundsServicePostFundsByFundIdUnmarkMutationResult = Awaited<ReturnType<typeof FundsService.postFundsByFundIdUnmark>>;
export type FundsServicePostFundsTableTabByTabSortMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabSort>>;
export type FundsServicePostFundsTableTabByTabColumnsMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabColumns>>;
export type FundsServicePostFundsTableTabByTabColumnsResetMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabColumnsReset>>;
export type FundsServicePostFundsTableTabByTabColumnMutationResult = Awaited<ReturnType<typeof FundsService.postFundsTableTabByTabColumn>>;
export type FundsServicePostFundsStockByFundIdSummaryCaseByCaseMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdSummaryCaseByCase>>;
export type FundsServicePostFundsStockByFundIdReturnAnalysisReturnTrendMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdReturnAnalysisReturnTrend>>;
export type FundsServicePostFundsStockByFundIdReturnAnalysisReturnComparisonMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdReturnAnalysisReturnComparison>>;
export type FundsServicePostFundsStockByFundIdReturnAnalysisReturnRankMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdReturnAnalysisReturnRank>>;
export type FundsServicePostFundsStockByFundIdReturnAnalysisRiskReturnAnalysisMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdReturnAnalysisRiskReturnAnalysis>>;
export type FundsServicePostFundsStockByFundIdReturnAnalysisSeasonalityEffectAnalysisMutationResult = Awaited<ReturnType<typeof FundsService.postFundsStockByFundIdReturnAnalysisSeasonalityEffectAnalysis>>;
...
export type FundsServicePutFundsByFundIdWatchlistMutationResult = Awaited<ReturnType<typeof FundsService.putFundsByFundIdWatchlist>>;
...
export type FundsServiceDeleteFundsByFundIdWatchlistMutationResult = Awaited<ReturnType<typeof FundsService.deleteFundsByFundIdWatchlist>>;
