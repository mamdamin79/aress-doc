...
export const useReportsServiceGetReportsByReportId = <TData = Common.ReportsServiceGetReportsByReportIdDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ reportId }: {
  reportId: number;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseReportsServiceGetReportsByReportIdKeyFn({ reportId }, queryKey), queryFn: () => ReportsService.getReportsByReportId({ reportId }) as TData, ...options });
...
export const useDashboardsServiceGetDashboardsByDashboardIdItemsPreview = <TData = Common.DashboardsServiceGetDashboardsByDashboardIdItemsPreviewDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ dashboardId }: {
  dashboardId: number;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn">) => useQuery<TData, TError>({ queryKey: Common.UseDashboardsServiceGetDashboardsByDashboardIdItemsPreviewKeyFn({ dashboardId }, queryKey), queryFn: () => DashboardsService.getDashboardsByDashboardIdItemsPreview({ dashboardId }) as TData, ...options });
...
export const useUsersServicePostUsersPasswordForgotCaptcha = <TData = Common.UsersServicePostUsersPasswordForgotCaptchaMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  captchaHeight?: number;
  captchaType?: CaptchaType;
  captchaWidth?: number;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  ...
  captchaType?: CaptchaType;
  captchaWidth?: number;
}, TContext>({ mutationFn: ({ captchaHeight, captchaType, captchaWidth }) => UsersService.postUsersPasswordForgotCaptcha({ captchaHeight, captchaType, captchaWidth }) as unknown as Promise<TData>, ...options });
...
export const useDashboardsServicePostDashboardsByDashboardIdItems = <TData = Common.DashboardsServicePostDashboardsByDashboardIdItemsMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  ...
  dashboardId: number;
  requestBody: GetDashboardItemCalculationsBody;
}, TContext>({ mutationFn: ({ dashboardId, requestBody }) => DashboardsService.postDashboardsByDashboardIdItems({ dashboardId, requestBody }) as unknown as Promise<TData>, ...options });
export const useDashboardsServicePostDashboardsByDashboardIdItemsReorder = <TData = Common.DashboardsServicePostDashboardsByDashboardIdItemsReorderMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  dashboardId: number;
  requestBody: ChangeDashboardReportItemSortOrderBody;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  dashboardId: number;
  requestBody: ChangeDashboardReportItemSortOrderBody;
}, TContext>({ mutationFn: ({ dashboardId, requestBody }) => DashboardsService.postDashboardsByDashboardIdItemsReorder({ dashboardId, requestBody }) as unknown as Promise<TData>, ...options });
export const useFundsServicePostFundsTablePin = <TData = Common.FundsServicePostFundsTablePinMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  requestBody: PinFundInTableTabBody;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  requestBody: PinFundInTableTabBody;
}, TContext>({ mutationFn: ({ requestBody }) => FundsService.postFundsTablePin({ requestBody }) as unknown as Promise<TData>, ...options });
export const useFundsServicePostFundsTableUnpin = <TData = Common.FundsServicePostFundsTableUnpinMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  requestBody: UnpinFundInTableTabBody;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  requestBody: UnpinFundInTableTabBody;
}, TContext>({ mutationFn: ({ requestBody }) => FundsService.postFundsTableUnpin({ requestBody }) as unknown as Promise<TData>, ...options });
...
export const useDashboardsServicePutDashboardsByDashboardIdItems = <TData = Common.DashboardsServicePutDashboardsByDashboardIdItemsMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  dashboardId: number;
  requestBody: AddReportToDashboardForUserBody;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  dashboardId: number;
  requestBody: AddReportToDashboardForUserBody;
}, TContext>({ mutationFn: ({ dashboardId, requestBody }) => DashboardsService.putDashboardsByDashboardIdItems({ dashboardId, requestBody }) as unknown as Promise<TData>, ...options });
...
export const useDashboardsServiceDeleteDashboardsByDashboardIdItems = <TData = Common.DashboardsServiceDeleteDashboardsByDashboardIdItemsMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
  dashboardId: number;
  requestBody: DeleteDashboardItemFromDashboardBody;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
  dashboardId: number;
  requestBody: DeleteDashboardItemFromDashboardBody;
}, TContext>({ mutationFn: ({ dashboardId, requestBody }) => DashboardsService.deleteDashboardsByDashboardIdItems({ dashboardId, requestBody }) as unknown as Promise<TData>, ...options });
