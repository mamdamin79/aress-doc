...
> = ({ title, type, description, price, status, isOpen, icon, image }) => {
  return (
    <div
      className={cn(
        'text-text-neutral-primary bg-surface-neutral-background hover:bg-surface-neutral-tertiary flex w-full flex-row items-center justify-between rounded-2xl p-3 transition-colors',
        isOpen && 'bg-surface-neutral-tertiary rounded-b-none',
      )}
    >
