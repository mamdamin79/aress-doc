...
export const FilterReportClient = () => {
  ...
  const updateURL = (newFilter: typeof filter) => {
    ...
    if (newFilter.onlyFavorite) {
      params.set('onlyFavorite', 'true');
    } else {
      params.delete('onlyFavorite');
    }

    if (newFilter.onlyNew) {
      params.set('onlyNew', 'true');
    } else {
      params.delete('onlyNew');
    }

    if (newFilter.onlyHavingVideo) {
      params.set('onlyHavingVideo', 'true');
    } else {
      params.delete('onlyHavingVideo');
    }
