  ...
  return (
    <tr className="flex h-12 animate-pulse items-center border-b pr-8">
      <td className="flex gap-1">
        <div className="h-6 w-9 rounded-md skeleton-shimmer" />
        <div className="h-6 w-[62px] rounded-md skeleton-shimmer" />
      </td>
      <td className="ml-[140px] mr-[26px] flex gap-2">
        <div className="h-8 w-8 rounded-full skeleton-shimmer" />
        <div className="h-[26px] w-[74px] rounded-xl skeleton-shimmer" />
      </td>

      {[...Array(columnCount)].map((_, index) => (
        <td key={index}>
          <div className="ml-[70px] h-[26px] w-[74px] rounded-xl skeleton-shimmer" />
        </td>
      ))}
    </tr>
  );
