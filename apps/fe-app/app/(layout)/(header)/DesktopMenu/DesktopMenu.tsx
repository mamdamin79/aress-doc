...
export const DesktopMenu: React.FC<MenuProps> = ({ menuItems, activeTab }) => {
  ...
  const renderDropdownMenu = (item: MenuItem, index: number) => (
    <div className="bg-baseBackground shadow-offset-y-10 shadow-8xl absolute z-10 z-50 flex hidden flex-row rounded-xl border-2 border-gray-300 group-hover:block">
